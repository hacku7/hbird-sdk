...
import (
	...
	restclient "github.com/hacku7/hbird-sdk/rest"
)

// Server contains information about how to communicate with a iam api-base server.
type Server struct {
...
// Config defines a config struct used by hbird-sdk.
type Config struct {
...
// ClientConfig is used to make it easy to get an api-base server client.
...
// the config is useable.  There might still be errors-base-sdk in the config, but no errors-base-sdk in the
// sections requested or referenced.  It does not return early so that it can find as many errors-base-sdk as possible.
