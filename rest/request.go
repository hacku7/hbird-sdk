...
import (
	...
	"github.com/hacku7/component-base-sdk/pkg/runtime"

	"github.com/hacku7/hbird-sdk/third_party/forked/gorequest"
)

// Request allows for building up a request to a server in a chained fashion.
// Any errors-base-sdk are stored until the end of your call, so you only have to
// check once.
type Request struct {
	c *RESTClient
...
func NewRequest(c *RESTClient) *Request {
	...
	case c.content.HasKeyAuth():
		tokenString := auth.Sign(c.content.SecretID, c.content.SecretKey, "hbird-sdk", c.group+".hbird.com")
